class Mda < Formula
  ...
  url "https://github.com/klabast/macOSDefaultApps/releases/download/v0.7.1/mda-0.7.1-universal.tar.gz"
  sha256 "095096069e8a6e0c5f85d7fb8b0b9bc995a7d4b594054177c98608254425e6d9"
  license "MIT"
